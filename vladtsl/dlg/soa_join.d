...
CHAIN
IF WEIGHT #2 ~InParty("Yoshimo") Global("ttKachiko_Meet","GLOBAL",2)~ THEN TTKACHI 0
...
DO ~SetGlobal("ttKachiko_Meet","GLOBAL",3)~
...
DO ~SetGlobalTimer("ttKachikoRomanceTimer","GLOBAL",ONE_DAY)
SetGlobal("ttKachiko_Joined","GLOBAL",1)
JoinParty()~
EXIT
...
SetGlobal("Kicked_Out","LOCALS",1)
ActionOverride("ttkachi",EscapeAreaMove("TT0102",165,727,8))
LeaveParty()
...
DO ~SetGlobal("Kicked_Out","LOCALS",1)
ActionOverride("ttkachi",EscapeAreaMove("AR0406",1368,1922,0))
ChangeAIScript("",DEFAULT)
SetLeavePartyDialogFile()
LeaveParty()
...
~Sorry, <CHARNAME>. I cannot leave her alone. We must continue our mission.~
DO ~SetGlobal("Kicked_Out","LOCALS",1)
ActionOverride("ttkachi",EscapeAreaMove("TT0100",165,727,8))
ChangeAIScript("",DEFAULT)
SetLeavePartyDialogFile()
LeaveParty()
...
END
 ...
 IF ~Global("ttInHalruaa","GLOBAL",0) Global("ttOnIsland","GLOBAL",0)~ THEN REPLY ~Perhaps at a major inn or tavern? Somewhere we are sure to go.~ EXTERN YOSHP partway1
...
Global("ttOnIsland","GLOBAL",1)~ THEN YOSHP TS11
