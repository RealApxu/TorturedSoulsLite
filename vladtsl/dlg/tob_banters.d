...
CHAIN
IF ~Global("ttKachikoRomanceTOB","GLOBAL",2)~ THEN TTKACH2B YoshiKachiLoveTalk1TOB
@0
DO ~IncrementGlobal("ttKachikoRomanceTOB","GLOBAL",1) SetGlobalTimer("ttKachikoRomanceTimerTOB","GLOBAL",ONE_DAY)~
== TTYOSH2B @1
== TTKACH2B @2
== TTYOSH2B @3
== TTKACH2B @4
...
CHAIN
IF ~Global("ttKachikoRomanceTOB","GLOBAL",4)~ THEN TTKACH2B YoshiKachiLoveTalk2TOB
@5
DO ~IncrementGlobal("ttKachikoRomanceTOB","GLOBAL",1) SetGlobalTimer("ttKachikoRomanceTimerTOB","GLOBAL",ONE_DAY)~
== TTYOSH2B @6
== TTKACH2B @7
...
CHAIN
IF ~Global("ttKachikoRomanceTOB","GLOBAL",6)~ THEN TTKACH2B YoshiKachiLoveTalk3TOB
@14
DO ~IncrementGlobal("ttKachikoRomanceTOB","GLOBAL",1) SetGlobalTimer("ttKachikoRomanceTimerTOB","GLOBAL",ONE_DAY)~
== TTYOSH2B @15
== TTKACH2B @16
