...
CHAIN
IF ~Global("ttKachikoLoveTalk","GLOBAL",2)~ THEN TTKACHIB YoshiKachiLoveTalk1
@152
DO ~IncrementGlobal("ttKachikoLoveTalk","GLOBAL",1) SetGlobalTimer("ttKachikoRomanceTimer","GLOBAL",ONE_DAY)~
== BYOSHIM @153
== TTKACHIB @154
== BYOSHIM @155
== TTKACHIB @156
...
CHAIN
IF ~Global("ttKachikoLoveTalk","GLOBAL",4)~ THEN TTKACHIB YoshiKachiLoveTalk2
@158
DO ~IncrementGlobal("ttKachikoLoveTalk","GLOBAL",1) SetGlobalTimer("ttKachikoRomanceTimer","GLOBAL",TWO_DAYS)~
== BYOSHIM @159
== TTKACHIB @160
== BYOSHIM @161
DO ~RestParty()~
...
CHAIN
IF ~Global("ttKachikoLoveTalk","GLOBAL",6)~ THEN TTKACHIB YoshiKachiLoveTalk3
@162
DO ~IncrementGlobal("ttKachikoLoveTalk","GLOBAL",1) SetGlobalTimer("ttKachikoRomanceTimer","GLOBAL",ONE_DAY)~
== BYOSHIM @163
== TTKACHIB @164
...
CHAIN
IF ~Global("ttKachikoLoveTalk","GLOBAL",8)~ THEN TTKACHIB YoshiKachiLoveTalk4
@170
DO ~IncrementGlobal("ttKachikoLoveTalk","GLOBAL",1) SetGlobalTimer("ttKachikoRomanceTimer","GLOBAL",ONE_DAY)~
== BYOSHIM @171
== TTKACHIB @172
...
CHAIN
IF ~Global("ttKachikoLoveTalk","GLOBAL",10)~ THEN TTKACHIB YoshiKachiLoveTalk5
@178
DO ~IncrementGlobal("ttKachikoLoveTalk","GLOBAL",1)~
== BYOSHIM @179
== TTKACHIB @180
== BYOSHIM @181
== TTKACHIB @182
...
CHAIN
IF ~Global("ttKachikoLoveTalk","GLOBAL",12)~ THEN TTKACHIB YoshiKachiLoveTalk6
@184
DO ~IncrementGlobal("ttKachikoLoveTalk","GLOBAL",1)~
== BYOSHIM @185
== TTKACHIB @186
