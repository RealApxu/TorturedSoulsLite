...
END
 ++ @8 EXTERN VPNAJOKI 4
 ++ @9 DO ~GiveItemCreate("SCRL63",Player1,0,0,0)~ EXIT
 ++ @10 EXTERN VPNAJOKI 7

CHAIN VPNAJOKI 4
@11
END
 ++ @12 EXTERN VPNAJOKI 5

CHAIN VPNAJOKI 5
@13
END
 ++ @14 EXTERN VPNAJOKI 6
 ++ @15 DO ~GiveItemCreate("SCRL63",Player1,0,0,0)~ EXIT
 ++ @10 EXTERN VPNAJOKI 7
...
@22
END
 ++ @23 DO ~GiveItemCreate("SCRL63",Player1,0,0,0)~ EXIT
 ++ @24 DO ~SetGlobal("TT_Evil_Path","GLOBAL",2) Enemy()~ EXIT
